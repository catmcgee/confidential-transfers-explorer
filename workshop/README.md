...
A five-step walkthrough of Solana Token-2022 Confidential Transfers on devnet. Each step matches an action in the [deployed explorer app](https://confidential-transfers-explorer-web.vercel.app): the markdown guide explains what happens under the hood (with diagrams and protocol internals), and the numbered script is a minimal, standalone version of exactly what the app does — runnable against devnet, narrating itself via `console.log`.
...
|---|---|---|---|---|
| 01 | The mint behind the faucet | [`01-create-mint.ts`](01-create-mint.ts) | [`01-create-mint.md`](01-create-mint.md) | The mint opts in via one extension; the auditor field is the compliance hook |
...
| 05 | **Click to decrypt** balances | [`05-decrypt.ts`](05-decrypt.ts) | [`05-decrypt.md`](05-decrypt.md) | ElGamal vs AES decryption paths; what an outsider sees (ciphertext) |
